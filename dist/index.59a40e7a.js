...
var _declarationsJs = require("./declarations.js");
var _methodsJs = require("./methods.js");
var _requestsJs = require("./requests.js");
var _handlersJs = require("./handlers.js");
// Add event listeners
(0, _declarationsJs.addTaskFormElement).addEventListener("submit", (0, _handlersJs.handleSubmitFormAddTask));
(0, _declarationsJs.editTaskFormElement).addEventListener("submit", (0, _handlersJs.handleSubmitFormEditTask));
(0, _declarationsJs.addTaskModalElement).addEventListener("hidden.bs.modal", (0, _handlersJs.handleCloseModalAddTask));
(0, _declarationsJs.tasksBlock).addEventListener("click", (0, _handlersJs.handleClickWrapperTasks));
(0, _declarationsJs.deleteConfirmationButtonElement).addEventListener("click", (0, _handlersJs.handleClickButtonDeleteDone));
// Initializing
(0, _requestsJs.getUsers)();
(0, _methodsJs.render)((0, _methodsJs.getTasksFromStorage)());
document.addEventListener("DOMContentLoaded", (0, _methodsJs.getCurrentTime));
setInterval((0, _methodsJs.getCurrentTime), 1000);

},{"./methods.js":"QcWvL","./requests.js":"gUqKo","./handlers.js":"jlk9X","./declarations.js":"5uDhp"}],"QcWvL":[function(require,module,exports) {
...
parcelHelpers.export(exports, "getColorClass", ()=>getColorClass);
parcelHelpers.export(exports, "saveTasksToStorage", ()=>saveTasksToStorage);
parcelHelpers.export(exports, "getTasksFromStorage", ()=>getTasksFromStorage);
parcelHelpers.export(exports, "saveUsersToStorage", ()=>saveUsersToStorage);
parcelHelpers.export(exports, "getUsersFromStorage", ()=>getUsersFromStorage);
parcelHelpers.export(exports, "render", ()=>render);
parcelHelpers.export(exports, "getCurrentTime", ()=>getCurrentTime);
parcelHelpers.export(exports, "updateTaskCount", ()=>updateTaskCount);
parcelHelpers.export(exports, "showEmptyListMessage", ()=>showEmptyListMessage);
parcelHelpers.export(exports, "toggleDeleteAllButton", ()=>toggleDeleteAllButton);
...
function getCurrentTime() {
    ...
    timeElement.insertAdjacentHTML("afterbegin", (0, _templatesJs.buildTemplateTime)(currentHours, currentMinutes, currentSeconds));
}
...
function render(tasks) {
    ...
    sortedTasks.forEach(({ title, description, userId, createdAt, colorClass, taskId, status })=>{
        ...
        ;
        const taskHTML = (0, _templatesJs.buildTemplateTask)({
            title,
            description,
            userId: userName,
            createdAt,
        ...
        ;
        if (status == "todo") todoBlock.insertAdjacentHTML("beforeend", taskHTML);
        else if (status == "in-progress") progressBlock.insertAdjacentHTML("beforeend", taskHTML);
        else if (status == "done") doneBlock.insertAdjacentHTML("beforeend", taskHTML);
    });
...
function showEmptyListMessage(tasks, block) {
    if (tasks.length == 0) block.innerHTML = '<div class="board__empty-list">Empty List</div>';
}
function toggleDeleteAllButton(tasks) {
    doneTasks = tasks.filter((task)=>task.status == "done");
    const deleteAllButtonElement = document.querySelector(".board__delete-button");
    if (doneTasks.length > 0) deleteAllButtonElement.classList.remove("d-none");
    else deleteAllButtonElement.classList.add("d-none");
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./templates.js":"18mfC"}],"gkKU3":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "buildTemplateTask", ()=>buildTemplateTask);
parcelHelpers.export(exports, "buildTemplateTime", ()=>buildTemplateTime);
...
async function getUsers() {
    try {
        ...
        (0, _methodsJs.saveUsersToStorage)(users);
        renderUsers(users);
    } catch (error) {
        if (error.status) renderErrorOption(`Request error: ${error.status}`);
        else {
            console.warn(error);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./methods.js":"QcWvL"}],"jlk9X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleSubmitFormAddTask", ()=>handleSubmitFormAddTask);
parcelHelpers.export(exports, "handleSubmitFormEditTask", ()=>handleSubmitFormEditTask);
parcelHelpers.export(exports, "handleCloseModalAddTask", ()=>handleCloseModalAddTask);
parcelHelpers.export(exports, "handleClickWrapperTasks", ()=>handleClickWrapperTasks);
parcelHelpers.export(exports, "handleClickButtonDeleteDone", ()=>handleClickButtonDeleteDone);
var _declarationsJs = require("./declarations.js");
var _modelsJs = require("./models.js");
var _methodsJs = require("./methods.js");
function handleSubmitFormAddTask(event) {
    event.preventDefault();
    const tasks = (0, _methodsJs.getTasksFromStorage)();
    const formData = new FormData((0, _declarationsJs.addTaskFormElement));
    ...
    ;
    const task = new (0, _modelsJs.Task)(title, description, userId);
    tasks.push(task);
    (0, _methodsJs.saveTasksToStorage)(tasks);
    (0, _methodsJs.render)(tasks);
    (0, _declarationsJs.addTaskModal).hide();
    (0, _declarationsJs.addTaskFormElement).reset();
}
function handleSubmitFormEditTask(event) {
    event.preventDefault();
    let tasks = (0, _methodsJs.getTasksFromStorage)();
    const formData = new FormData((0, _declarationsJs.editTaskFormElement));
    const fromDataEntries = Object.fromEntries(formData.entries());
    const { taskIdValue, editedTitle, editedDescription, editedUserId } = fromDataEntries;
    tasks = tasks.map((task)=>{
        if (task.taskId == taskIdValue) return {
            ...task,
            title: editedTitle,
    ...
    (0, _methodsJs.saveTasksToStorage)(tasks);
    (0, _methodsJs.render)(tasks);
    (0, _declarationsJs.editTaskModal).hide();
    (0, _declarationsJs.editTaskFormElement).reset();
}
...
function handleClickWrapperTasks({ target }) {
    ...
    ;
    if (target.classList.contains("dropdown-item-todo") || target.classList.contains("dropdown-item-progress") || target.classList.contains("dropdown-item-done")) isTasksModified = onClickDropdownMove(target, tasks, taskId);
    else if (target.classList.contains("board__task-delete")) isTasksModified = onClickButtonDelete(tasks, taskId);
    else if (target.classList.contains("board__task-edit")) isTasksModified = onClickButtonEdit(tasks, taskId);
    if (isTasksModified) {
        (0, _methodsJs.saveTasksToStorage)(tasks);
        (0, _methodsJs.render)(tasks);
    }
...
function handleClickButtonDeleteDone() {
    ...
    (0, _methodsJs.saveTasksToStorage)(tasks);
    (0, _methodsJs.render)(tasks);
    (0, _declarationsJs.deleteConfirmationModal).hide();
}
// OnClick functions for handleClickWrapperTasks
function onClickDropdownMove(target, tasks, taskId) {
    const task = tasks.find((task)=>task.taskId == taskId);
    if (target.classList.contains("dropdown-item-todo")) task.status = "todo";
        ...
        if (progressTasksLength <= 5) task.status = "in-progress";
        else {
            (0, _declarationsJs.limitWarningModal).show();
            return false;
        }
    } else task.status = "done";
    task.colorClass = (0, _methodsJs.getColorClass)(task.status);
...
function onClickButtonEdit(tasks, taskId) {
    ...
    if (task) {
        ...
        ;
        (0, _declarationsJs.editTaskModal).show();
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./declarations.js":"5uDhp","./models.js":"edpJG","./methods.js":"QcWvL"}],"5uDhp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addTaskModalElement", ()=>addTaskModalElement);
parcelHelpers.export(exports, "editTaskModalElement", ()=>editTaskModalElement);
parcelHelpers.export(exports, "deleteTasksModalElement", ()=>deleteTasksModalElement);
parcelHelpers.export(exports, "taskLimitModalElement", ()=>taskLimitModalElement);
parcelHelpers.export(exports, "addTaskModal", ()=>addTaskModal);
parcelHelpers.export(exports, "editTaskModal", ()=>editTaskModal);
parcelHelpers.export(exports, "deleteConfirmationModal", ()=>deleteConfirmationModal);
parcelHelpers.export(exports, "limitWarningModal", ()=>limitWarningModal);
parcelHelpers.export(exports, "addTaskFormElement", ()=>addTaskFormElement);
parcelHelpers.export(exports, "editTaskFormElement", ()=>editTaskFormElement);
parcelHelpers.export(exports, "tasksBlock", ()=>tasksBlock);
parcelHelpers.export(exports, "deleteConfirmationButtonElement", ()=>deleteConfirmationButtonElement);
...
const addTaskModal = new (0, _bootstrap.Modal)(addTaskModalElement) //Initializing a modal to have access to its methods
;
const editTaskModal = new (0, _bootstrap.Modal)(editTaskModalElement);
const deleteConfirmationModal = new (0, _bootstrap.Modal)(deleteTasksModalElement);
const limitWarningModal = new (0, _bootstrap.Modal)(taskLimitModalElement);
//Other variables
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"edpJG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Task {
    constructor(title, description, user){
        this.taskId = (0, _methodsJs.generateUniqueId)();
        this.title = title;
        this.description = description;
        this.userId = user;
        this.status = "todo";
        this.createdAt = (0, _methodsJs.getCurrentDate)();
        this.colorClass = (0, _methodsJs.getColorClass)(this.status);
        this.movedAt = new Date() // for sorting tasks by move time
        ;
    }
}

},{"./methods.js":"QcWvL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aP7aF","8lRBv"], "8lRBv", "parcelRequire1ac5")
